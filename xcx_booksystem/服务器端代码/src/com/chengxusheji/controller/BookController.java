...
public class BookController extends BaseController {
	...
	public void add(@Validated Book book, BindingResult br,
		...
		book.setBookFile(this.handleFileUpload(request, "bookFileFile"));
	...
	public void update(@Validated Book book, BindingResult br,
		...
		String bookFileFileName = this.handleFileUpload(request, "bookFileFile");
		if(!bookFileFileName.equals(""))book.setBookFile(bookFileFileName);
		try {
